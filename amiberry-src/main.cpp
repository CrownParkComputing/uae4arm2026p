...
static int real_main2 (int argc, TCHAR **argv)
{
	...
	// Re-resolve any joyport shortids (e.g. "joy1") that failed during
	// config parsing because the joystick subsystem was not yet initialised.
	inputdevice_fix_prefs_post_init(&currprefs);
